...
@test Healpix.conformables(Healpix.PolarizedMap{Int16,Healpix.RingOrder}(4), 
...
@test !Healpix.conformables(Healpix.PolarizedMap{Int16,Healpix.RingOrder}(8),
...
@test !Healpix.conformables(Healpix.PolarizedMap{Float32,Healpix.RingOrder}(4),
