...
@testset "pix2ringpos, NSIDE=1" begin
    resol = Healpix.Resolution(1)

    @test Healpix.pix2ringpos(resol, 1) == (:equator, 1, 1)
    @test Healpix.pix2ringpos(resol, 2) == (:equator, 1, 2)
    @test Healpix.pix2ringpos(resol, 3) == (:equator, 1, 3)
    @test Healpix.pix2ringpos(resol, 4) == (:equator, 1, 4)
    @test Healpix.pix2ringpos(resol, 5) == (:equator, 2, 1)
    @test Healpix.pix2ringpos(resol, 6) == (:equator, 2, 2)
    @test Healpix.pix2ringpos(resol, 7) == (:equator, 2, 3)
    @test Healpix.pix2ringpos(resol, 8) == (:equator, 2, 4)
    @test Healpix.pix2ringpos(resol, 9) == (:equator, 3, 1)
    @test Healpix.pix2ringpos(resol, 10) == (:equator, 3, 2)
    @test Healpix.pix2ringpos(resol, 11) == (:equator, 3, 3)
    @test Healpix.pix2ringpos(resol, 12) == (:equator, 3, 4)
end

@testset "pix2ringpos, NSIDE=2" begin
    resol = Healpix.Resolution(2)

    @test Healpix.pix2ringpos(resol, 1) == (:northcap, 1, 1)
    @test Healpix.pix2ringpos(resol, 2) == (:northcap, 1, 2)
    @test Healpix.pix2ringpos(resol, 3) == (:northcap, 1, 3)
    @test Healpix.pix2ringpos(resol, 4) == (:northcap, 1, 4)
    @test Healpix.pix2ringpos(resol, 5) == (:equator, 2, 1)
    @test Healpix.pix2ringpos(resol, 6) == (:equator, 2, 2)
    @test Healpix.pix2ringpos(resol, 7) == (:equator, 2, 3)
    @test Healpix.pix2ringpos(resol, 8) == (:equator, 2, 4)
    @test Healpix.pix2ringpos(resol, 9) == (:equator, 2, 5)
    @test Healpix.pix2ringpos(resol, 10) == (:equator, 2, 6)
    @test Healpix.pix2ringpos(resol, 11) == (:equator, 2, 7)
    @test Healpix.pix2ringpos(resol, 12) == (:equator, 2, 8)
    @test Healpix.pix2ringpos(resol, 13) == (:equator, 3, 1)
    @test Healpix.pix2ringpos(resol, 14) == (:equator, 3, 2)
    @test Healpix.pix2ringpos(resol, 15) == (:equator, 3, 3)
    @test Healpix.pix2ringpos(resol, 16) == (:equator, 3, 4)
    @test Healpix.pix2ringpos(resol, 17) == (:equator, 3, 5)
    @test Healpix.pix2ringpos(resol, 18) == (:equator, 3, 6)
    @test Healpix.pix2ringpos(resol, 19) == (:equator, 3, 7)
    @test Healpix.pix2ringpos(resol, 20) == (:equator, 3, 8)
    @test Healpix.pix2ringpos(resol, 21) == (:equator, 4, 1)
    @test Healpix.pix2ringpos(resol, 22) == (:equator, 4, 2)
    @test Healpix.pix2ringpos(resol, 23) == (:equator, 4, 3)
    @test Healpix.pix2ringpos(resol, 24) == (:equator, 4, 4)
    @test Healpix.pix2ringpos(resol, 25) == (:equator, 4, 5)
    @test Healpix.pix2ringpos(resol, 26) == (:equator, 4, 6)
    @test Healpix.pix2ringpos(resol, 27) == (:equator, 4, 7)
    @test Healpix.pix2ringpos(resol, 28) == (:equator, 4, 8)
    @test Healpix.pix2ringpos(resol, 29) == (:equator, 5, 1)
    @test Healpix.pix2ringpos(resol, 30) == (:equator, 5, 2)
    @test Healpix.pix2ringpos(resol, 31) == (:equator, 5, 3)
    @test Healpix.pix2ringpos(resol, 32) == (:equator, 5, 4)
    @test Healpix.pix2ringpos(resol, 33) == (:equator, 5, 5)
    @test Healpix.pix2ringpos(resol, 34) == (:equator, 5, 6)
    @test Healpix.pix2ringpos(resol, 35) == (:equator, 5, 7)
    @test Healpix.pix2ringpos(resol, 36) == (:equator, 5, 8)
    @test Healpix.pix2ringpos(resol, 37) == (:equator, 6, 1)
    @test Healpix.pix2ringpos(resol, 38) == (:equator, 6, 2)
    @test Healpix.pix2ringpos(resol, 39) == (:equator, 6, 3)
    @test Healpix.pix2ringpos(resol, 40) == (:equator, 6, 4)
    @test Healpix.pix2ringpos(resol, 41) == (:equator, 6, 5)
    @test Healpix.pix2ringpos(resol, 42) == (:equator, 6, 6)
    @test Healpix.pix2ringpos(resol, 43) == (:equator, 6, 7)
    @test Healpix.pix2ringpos(resol, 44) == (:equator, 6, 8)
    @test Healpix.pix2ringpos(resol, 45) == (:southcap, 7, 1)
    @test Healpix.pix2ringpos(resol, 46) == (:southcap, 7, 2)
    @test Healpix.pix2ringpos(resol, 47) == (:southcap, 7, 3)
    @test Healpix.pix2ringpos(resol, 48) == (:southcap, 7, 4)
end

@testset "pix2ringpos, NSIDE=4" begin
    ...
    @test Healpix.pix2ringpos(resol, 3) == (:northcap, 1, 3)
    @test Healpix.pix2ringpos(resol, 4) == (:northcap, 1, 4)
    @test Healpix.pix2ringpos(resol, 5) == (:northcap, 2, 1)
    @test Healpix.pix2ringpos(resol, 6) == (:northcap, 2, 2)
    @test Healpix.pix2ringpos(resol, 7) == (:northcap, 2, 3)
    @test Healpix.pix2ringpos(resol, 8) == (:northcap, 2, 4)
    @test Healpix.pix2ringpos(resol, 9) == (:northcap, 2, 5)
    @test Healpix.pix2ringpos(resol, 10) == (:northcap, 2, 6)
    @test Healpix.pix2ringpos(resol, 11) == (:northcap, 2, 7)
    @test Healpix.pix2ringpos(resol, 12) == (:northcap, 2, 8)
    @test Healpix.pix2ringpos(resol, 13) == (:northcap, 3, 1)
    @test Healpix.pix2ringpos(resol, 14) == (:northcap, 3, 2)
    @test Healpix.pix2ringpos(resol, 15) == (:northcap, 3, 3)
    @test Healpix.pix2ringpos(resol, 16) == (:northcap, 3, 4)
    @test Healpix.pix2ringpos(resol, 17) == (:northcap, 3, 5)
    @test Healpix.pix2ringpos(resol, 18) == (:northcap, 3, 6)
    @test Healpix.pix2ringpos(resol, 19) == (:northcap, 3, 7)
    @test Healpix.pix2ringpos(resol, 20) == (:northcap, 3, 8)
    @test Healpix.pix2ringpos(resol, 21) == (:northcap, 3, 9)
    @test Healpix.pix2ringpos(resol, 22) == (:northcap, 3, 10)
    @test Healpix.pix2ringpos(resol, 23) == (:northcap, 3, 11)
    @test Healpix.pix2ringpos(resol, 24) == (:northcap, 3, 12)
    @test Healpix.pix2ringpos(resol, 25) == (:equator, 4, 1)
    @test Healpix.pix2ringpos(resol, 26) == (:equator, 4, 2)
    @test Healpix.pix2ringpos(resol, 27) == (:equator, 4, 3)
    @test Healpix.pix2ringpos(resol, 28) == (:equator, 4, 4)
    @test Healpix.pix2ringpos(resol, 29) == (:equator, 4, 5)
    @test Healpix.pix2ringpos(resol, 30) == (:equator, 4, 6)
    @test Healpix.pix2ringpos(resol, 31) == (:equator, 4, 7)
    @test Healpix.pix2ringpos(resol, 32) == (:equator, 4, 8)
    @test Healpix.pix2ringpos(resol, 33) == (:equator, 4, 9)
    @test Healpix.pix2ringpos(resol, 34) == (:equator, 4, 10)
    @test Healpix.pix2ringpos(resol, 35) == (:equator, 4, 11)
    @test Healpix.pix2ringpos(resol, 36) == (:equator, 4, 12)
    @test Healpix.pix2ringpos(resol, 37) == (:equator, 4, 13)
    @test Healpix.pix2ringpos(resol, 38) == (:equator, 4, 14)
    @test Healpix.pix2ringpos(resol, 39) == (:equator, 4, 15)
    @test Healpix.pix2ringpos(resol, 40) == (:equator, 4, 16)
    @test Healpix.pix2ringpos(resol, 41) == (:equator, 5, 1)
    @test Healpix.pix2ringpos(resol, 42) == (:equator, 5, 2)
    @test Healpix.pix2ringpos(resol, 43) == (:equator, 5, 3)
    @test Healpix.pix2ringpos(resol, 44) == (:equator, 5, 4)
    @test Healpix.pix2ringpos(resol, 45) == (:equator, 5, 5)
    @test Healpix.pix2ringpos(resol, 46) == (:equator, 5, 6)
    @test Healpix.pix2ringpos(resol, 47) == (:equator, 5, 7)
    @test Healpix.pix2ringpos(resol, 48) == (:equator, 5, 8)
    @test Healpix.pix2ringpos(resol, 49) == (:equator, 5, 9)
    @test Healpix.pix2ringpos(resol, 50) == (:equator, 5, 10)
    @test Healpix.pix2ringpos(resol, 51) == (:equator, 5, 11)
    @test Healpix.pix2ringpos(resol, 52) == (:equator, 5, 12)
    @test Healpix.pix2ringpos(resol, 53) == (:equator, 5, 13)
    @test Healpix.pix2ringpos(resol, 54) == (:equator, 5, 14)
    @test Healpix.pix2ringpos(resol, 55) == (:equator, 5, 15)
    @test Healpix.pix2ringpos(resol, 56) == (:equator, 5, 16)
    @test Healpix.pix2ringpos(resol, 57) == (:equator, 6, 1)
    @test Healpix.pix2ringpos(resol, 58) == (:equator, 6, 2)
    @test Healpix.pix2ringpos(resol, 59) == (:equator, 6, 3)
    @test Healpix.pix2ringpos(resol, 60) == (:equator, 6, 4)
    @test Healpix.pix2ringpos(resol, 61) == (:equator, 6, 5)
    @test Healpix.pix2ringpos(resol, 62) == (:equator, 6, 6)
    @test Healpix.pix2ringpos(resol, 63) == (:equator, 6, 7)
    @test Healpix.pix2ringpos(resol, 64) == (:equator, 6, 8)
    @test Healpix.pix2ringpos(resol, 65) == (:equator, 6, 9)
    @test Healpix.pix2ringpos(resol, 66) == (:equator, 6, 10)
    @test Healpix.pix2ringpos(resol, 67) == (:equator, 6, 11)
    @test Healpix.pix2ringpos(resol, 68) == (:equator, 6, 12)
    @test Healpix.pix2ringpos(resol, 69) == (:equator, 6, 13)
    @test Healpix.pix2ringpos(resol, 70) == (:equator, 6, 14)
    @test Healpix.pix2ringpos(resol, 71) == (:equator, 6, 15)
    @test Healpix.pix2ringpos(resol, 72) == (:equator, 6, 16)
    @test Healpix.pix2ringpos(resol, 73) == (:equator, 7, 1)
    @test Healpix.pix2ringpos(resol, 74) == (:equator, 7, 2)
    @test Healpix.pix2ringpos(resol, 75) == (:equator, 7, 3)
    @test Healpix.pix2ringpos(resol, 76) == (:equator, 7, 4)
    @test Healpix.pix2ringpos(resol, 77) == (:equator, 7, 5)
    @test Healpix.pix2ringpos(resol, 78) == (:equator, 7, 6)
    @test Healpix.pix2ringpos(resol, 79) == (:equator, 7, 7)
    @test Healpix.pix2ringpos(resol, 80) == (:equator, 7, 8)
    @test Healpix.pix2ringpos(resol, 81) == (:equator, 7, 9)
    @test Healpix.pix2ringpos(resol, 82) == (:equator, 7, 10)
    @test Healpix.pix2ringpos(resol, 83) == (:equator, 7, 11)
    @test Healpix.pix2ringpos(resol, 84) == (:equator, 7, 12)
    @test Healpix.pix2ringpos(resol, 85) == (:equator, 7, 13)
    @test Healpix.pix2ringpos(resol, 86) == (:equator, 7, 14)
    @test Healpix.pix2ringpos(resol, 87) == (:equator, 7, 15)
    @test Healpix.pix2ringpos(resol, 88) == (:equator, 7, 16)
    @test Healpix.pix2ringpos(resol, 89) == (:equator, 8, 1)
    @test Healpix.pix2ringpos(resol, 90) == (:equator, 8, 2)
    @test Healpix.pix2ringpos(resol, 91) == (:equator, 8, 3)
    @test Healpix.pix2ringpos(resol, 92) == (:equator, 8, 4)
    @test Healpix.pix2ringpos(resol, 93) == (:equator, 8, 5)
    @test Healpix.pix2ringpos(resol, 94) == (:equator, 8, 6)
    @test Healpix.pix2ringpos(resol, 95) == (:equator, 8, 7)
    @test Healpix.pix2ringpos(resol, 96) == (:equator, 8, 8)
    @test Healpix.pix2ringpos(resol, 97) == (:equator, 8, 9)
    @test Healpix.pix2ringpos(resol, 98) == (:equator, 8, 10)
    @test Healpix.pix2ringpos(resol, 99) == (:equator, 8, 11)
    @test Healpix.pix2ringpos(resol, 100) == (:equator, 8, 12)
    @test Healpix.pix2ringpos(resol, 101) == (:equator, 8, 13)
    @test Healpix.pix2ringpos(resol, 102) == (:equator, 8, 14)
    @test Healpix.pix2ringpos(resol, 103) == (:equator, 8, 15)
    @test Healpix.pix2ringpos(resol, 104) == (:equator, 8, 16)
    @test Healpix.pix2ringpos(resol, 105) == (:equator, 9, 1)
    @test Healpix.pix2ringpos(resol, 106) == (:equator, 9, 2)
    @test Healpix.pix2ringpos(resol, 107) == (:equator, 9, 3)
    @test Healpix.pix2ringpos(resol, 108) == (:equator, 9, 4)
    @test Healpix.pix2ringpos(resol, 109) == (:equator, 9, 5)
    @test Healpix.pix2ringpos(resol, 110) == (:equator, 9, 6)
    @test Healpix.pix2ringpos(resol, 111) == (:equator, 9, 7)
    @test Healpix.pix2ringpos(resol, 112) == (:equator, 9, 8)
    @test Healpix.pix2ringpos(resol, 113) == (:equator, 9, 9)
    @test Healpix.pix2ringpos(resol, 114) == (:equator, 9, 10)
    @test Healpix.pix2ringpos(resol, 115) == (:equator, 9, 11)
    @test Healpix.pix2ringpos(resol, 116) == (:equator, 9, 12)
    @test Healpix.pix2ringpos(resol, 117) == (:equator, 9, 13)
    @test Healpix.pix2ringpos(resol, 118) == (:equator, 9, 14)
    @test Healpix.pix2ringpos(resol, 119) == (:equator, 9, 15)
    @test Healpix.pix2ringpos(resol, 120) == (:equator, 9, 16)
    @test Healpix.pix2ringpos(resol, 121) == (:equator, 10, 1)
    @test Healpix.pix2ringpos(resol, 122) == (:equator, 10, 2)
    @test Healpix.pix2ringpos(resol, 123) == (:equator, 10, 3)
    @test Healpix.pix2ringpos(resol, 124) == (:equator, 10, 4)
    @test Healpix.pix2ringpos(resol, 125) == (:equator, 10, 5)
    @test Healpix.pix2ringpos(resol, 126) == (:equator, 10, 6)
    @test Healpix.pix2ringpos(resol, 127) == (:equator, 10, 7)
    @test Healpix.pix2ringpos(resol, 128) == (:equator, 10, 8)
    @test Healpix.pix2ringpos(resol, 129) == (:equator, 10, 9)
    @test Healpix.pix2ringpos(resol, 130) == (:equator, 10, 10)
    @test Healpix.pix2ringpos(resol, 131) == (:equator, 10, 11)
    @test Healpix.pix2ringpos(resol, 132) == (:equator, 10, 12)
    @test Healpix.pix2ringpos(resol, 133) == (:equator, 10, 13)
    @test Healpix.pix2ringpos(resol, 134) == (:equator, 10, 14)
    @test Healpix.pix2ringpos(resol, 135) == (:equator, 10, 15)
    @test Healpix.pix2ringpos(resol, 136) == (:equator, 10, 16)
    @test Healpix.pix2ringpos(resol, 137) == (:equator, 11, 1)
    @test Healpix.pix2ringpos(resol, 138) == (:equator, 11, 2)
    @test Healpix.pix2ringpos(resol, 139) == (:equator, 11, 3)
    @test Healpix.pix2ringpos(resol, 140) == (:equator, 11, 4)
    @test Healpix.pix2ringpos(resol, 141) == (:equator, 11, 5)
    @test Healpix.pix2ringpos(resol, 142) == (:equator, 11, 6)
    @test Healpix.pix2ringpos(resol, 143) == (:equator, 11, 7)
    @test Healpix.pix2ringpos(resol, 144) == (:equator, 11, 8)
    @test Healpix.pix2ringpos(resol, 145) == (:equator, 11, 9)
    @test Healpix.pix2ringpos(resol, 146) == (:equator, 11, 10)
    @test Healpix.pix2ringpos(resol, 147) == (:equator, 11, 11)
    @test Healpix.pix2ringpos(resol, 148) == (:equator, 11, 12)
    @test Healpix.pix2ringpos(resol, 149) == (:equator, 11, 13)
    @test Healpix.pix2ringpos(resol, 150) == (:equator, 11, 14)
    @test Healpix.pix2ringpos(resol, 151) == (:equator, 11, 15)
    @test Healpix.pix2ringpos(resol, 152) == (:equator, 11, 16)
    @test Healpix.pix2ringpos(resol, 153) == (:equator, 12, 1)
    @test Healpix.pix2ringpos(resol, 154) == (:equator, 12, 2)
    @test Healpix.pix2ringpos(resol, 155) == (:equator, 12, 3)
    @test Healpix.pix2ringpos(resol, 156) == (:equator, 12, 4)
    @test Healpix.pix2ringpos(resol, 157) == (:equator, 12, 5)
    @test Healpix.pix2ringpos(resol, 158) == (:equator, 12, 6)
    @test Healpix.pix2ringpos(resol, 159) == (:equator, 12, 7)
    @test Healpix.pix2ringpos(resol, 160) == (:equator, 12, 8)
    @test Healpix.pix2ringpos(resol, 161) == (:equator, 12, 9)
    @test Healpix.pix2ringpos(resol, 162) == (:equator, 12, 10)
    @test Healpix.pix2ringpos(resol, 163) == (:equator, 12, 11)
    @test Healpix.pix2ringpos(resol, 164) == (:equator, 12, 12)
    @test Healpix.pix2ringpos(resol, 165) == (:equator, 12, 13)
    @test Healpix.pix2ringpos(resol, 166) == (:equator, 12, 14)
    @test Healpix.pix2ringpos(resol, 167) == (:equator, 12, 15)
    @test Healpix.pix2ringpos(resol, 168) == (:equator, 12, 16)
    @test Healpix.pix2ringpos(resol, 169) == (:southcap, 13, 1)
    @test Healpix.pix2ringpos(resol, 170) == (:southcap, 13, 2)
    @test Healpix.pix2ringpos(resol, 171) == (:southcap, 13, 3)
    @test Healpix.pix2ringpos(resol, 172) == (:southcap, 13, 4)
    @test Healpix.pix2ringpos(resol, 173) == (:southcap, 13, 5)
    @test Healpix.pix2ringpos(resol, 174) == (:southcap, 13, 6)
    @test Healpix.pix2ringpos(resol, 175) == (:southcap, 13, 7)
    @test Healpix.pix2ringpos(resol, 176) == (:southcap, 13, 8)
    @test Healpix.pix2ringpos(resol, 177) == (:southcap, 13, 9)
    @test Healpix.pix2ringpos(resol, 178) == (:southcap, 13, 10)
    @test Healpix.pix2ringpos(resol, 179) == (:southcap, 13, 11)
    @test Healpix.pix2ringpos(resol, 180) == (:southcap, 13, 12)
    @test Healpix.pix2ringpos(resol, 181) == (:southcap, 14, 1)
    @test Healpix.pix2ringpos(resol, 182) == (:southcap, 14, 2)
    @test Healpix.pix2ringpos(resol, 183) == (:southcap, 14, 3)
    @test Healpix.pix2ringpos(resol, 184) == (:southcap, 14, 4)
    @test Healpix.pix2ringpos(resol, 185) == (:southcap, 14, 5)
    @test Healpix.pix2ringpos(resol, 186) == (:southcap, 14, 6)
    @test Healpix.pix2ringpos(resol, 187) == (:southcap, 14, 7)
    @test Healpix.pix2ringpos(resol, 188) == (:southcap, 14, 8)
    @test Healpix.pix2ringpos(resol, 189) == (:southcap, 15, 1)
    @test Healpix.pix2ringpos(resol, 190) == (:southcap, 15, 2)
    @test Healpix.pix2ringpos(resol, 191) == (:southcap, 15, 3)
    @test Healpix.pix2ringpos(resol, 192) == (:southcap, 15, 4)
end
